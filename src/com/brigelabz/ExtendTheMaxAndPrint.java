...
public class ExtendTheMaxAndPrint <T extends Comparable<T>>
{
...

    {
        ...
        {
            ExtendTheMaxAndPrint.checkMax(this.x,this.y,this.z1);
        }
    ...
    private void printMax(T x2, T y2, T z2, T max) 
    {
        System.out.println("Max of "+x2+","+y2+","+z2+" is " +max);
    }
